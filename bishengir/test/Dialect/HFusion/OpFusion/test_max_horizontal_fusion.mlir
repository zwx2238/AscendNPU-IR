// RUN: bishengir-opt %s --hfusion-fuse-ops="max-horizontal-fusion-size=-1" --split-input-file | FileCheck %s

// CHECK-LABEL: @main_multi_SHALLOW_CV_0_0(
// CHECK: arith.constant
// CHECK: broadcast
// CHECK: return
// CHECK-SAME: tensor<256x4096xf32>

// CHECK-LABEL: @main_multi_SHALLOW_CV_0(
// CHECK: fill
// CHECK-SAME: tensor<2x128xf32>
// CHECK: return

module {
  func.func @main_multi_SHALLOW_CV_0(%arg0: tensor<2x128x4096xf32>, %arg1: tensor<4096xf32>, %arg2: tensor<12288x4096xf32>) -> (tensor<2x128xf32>, tensor<2x128x1xf32>, tensor<2x128x12288xf32>) attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<HOST>, hfusion.fusion_kind = #hfusion.fusion_kind<LAST_AXIS_PBR>} {
